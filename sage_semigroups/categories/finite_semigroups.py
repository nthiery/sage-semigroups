...
class FiniteSemigroups:
    class ParentMethods:
        ...
        def is_aperiodic(self):
            ...
            """
            from sage.categories.aperiodic_monoids import AperiodicMonoids
        ...
        def is_l_trivial(self, **options):
            """
            Returns whether ``self`` is L-trivial
        ...
        def is_r_trivial(self, **options):
            """
            Returns whether ``self`` is R-trivial
            ...
            EXAMPLES::
                ...
                sage: S.category()
                Join of Category of sub finite monoids of functions and Category of finite h trivial monoids
                sage: S.is_r_trivial()
                False
                sage: S.category()
                Join of Category of sub finite monoids of functions and Category of finite h trivial monoids
        ...
        def is_DG(self, **options):
            ...
            EXAMPLES::
                ...
                sage: S = HTrivialMonoids().Finite().example(); S
        ...
        def is_basic(self):
            ...
            .. WARNING::
                ...
                Then answer actually depends on the ground field for
        ...
        def green_classes(self, side = "twosided"):
            ...
            EXAMPLES::
                ...
                sage: M = FiniteSemigroups().example(('a','b')); M
        ...
        def regular_j_classes(self):
            ...
            EXAMPLES::
                ...
                sage: S = FiniteSemigroups().example(('a','b','c'))
        ...
        def j_lequal(self, x, y):
            ...
            EXAMPLES::
                ...
                sage: S = FiniteSemigroups().example(alphabet=('a','b')); S
                An example of a finite semigroup: the left regular band generated by ('a', 'b')
        ...
        def regular_j_classes_keys(self):
            ...
            EXAMPLES::
                ...
                sage: S = FiniteSemigroups().example(alphabet=('a','b', 'c')); S
        ...
        def lr_regular_class(self, J, side='right'):
            ...
            EXAMPLES::
                ...
                sage: M = HTrivialMonoids().Finite().example(); M
                The finite H-trivial monoid of order preserving maps on {1, .., 3}
        ...
        def group_of_regular_j_class(self, J):
            ...
            return self.subquotient(self.lr_regular_class(J, side='h'),
                                    category = (Groups(), FiniteSemigroups().Subobjects()))
    ...
    class ElementMethods:
        def ideal(self, side = "twosided"):
            ...
            See also :meth:`FiniteSemigroups.ParentMethods.ideal`.
    ...
    #                     sage: A = FiniteSemigroups().example().character_ring(GF(2))
